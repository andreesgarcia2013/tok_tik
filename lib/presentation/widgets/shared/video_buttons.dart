...
class _CustomIconButton extends StatelessWidget {
  ...
  const _CustomIconButton({iconColor, required this.iconData, required this.value}):color=iconColor??Colors.white;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        if(value>0)
        Text(HumanFormarts.humanReadbleNumer(value.toDouble())),
      ],
    );
  }
}